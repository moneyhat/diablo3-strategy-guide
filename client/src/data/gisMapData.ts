...
// ─── TOWN HUB MAPS ────────────────────────────────────────────────────────────
// Detailed maps of the hub towns/villages for each Act
// These show artisan locations, NPCs, vendors, and transition points

export const act1TownData: ActGisData = {
  actId: "act1-town",
  actName: "New Tristram",
  subtitle: "Act I Hub — Walled Town of Khanduras",
  accentColor: "#8b0000",
  parchmentImage: "https://d2xsxph8kpxj0f.cloudfront.net/310519663366635630/Yxk9jCSLASZ3Pr5PiwqTMZ/town-new-tristram-SLQGscSWAtykXzmNTSGTfT.webp",
  viewBox: "0 0 1000 700",
  zones: [
    { id: "town-square", name: "Town Square", type: "town", polygon: [[35,35],[65,35],[65,65],[35,65]], centroid: [50,50], monsterTypes: [], density: 1, farmingRating: 1, eliteCount: 0, description: "The central square of New Tristram. The town well is here. All roads lead through this area.", farmingTip: "Use this as your navigation anchor. All artisans are within a short walk.", connectedTo: ["blacksmith-area","jeweler-area","mystic-area","town-gate","inn-area","graveyard"] },
    { id: "inn-area", name: "The Slaughtered Calf Inn", type: "town", polygon: [[10,30],[35,30],[35,55],[10,55]], centroid: [22,42], monsterTypes: [], density: 1, farmingRating: 1, eliteCount: 0, description: "The inn where Leah is staying. Contains the stash and the entrance to the cellar beneath.", farmingTip: "Your stash is here. Deposit items before heading out on long runs.", connectedTo: ["town-square","cellar-entrance"] },
    { id: "blacksmith-area", name: "Haedrig's Smithy", type: "town", polygon: [[60,25],[85,25],[85,50],[60,50]], centroid: [72,37], monsterTypes: [], density: 1, farmingRating: 1, eliteCount: 0, description: "Haedrig Eamon's blacksmith forge. Craft weapons, armor, and salvage items here.", farmingTip: "Salvage all magic and rare items you don't need. Materials are essential for crafting upgrades.", connectedTo: ["town-square"] },
    { id: "jeweler-area", name: "Covetous Shen's Workshop", type: "town", polygon: [[60,50],[85,50],[85,75],[60,75]], centroid: [72,62], monsterTypes: [], density: 1, farmingRating: 1, eliteCount: 0, description: "Covetous Shen's jeweler workshop. Socket gems, combine gems, and craft jewelry here.", farmingTip: "Combine lower-tier gems into higher-tier ones whenever possible. Marquise gems are the minimum for endgame.", connectedTo: ["town-square"] },
    { id: "mystic-area", name: "Myriam's Mystic Shop", type: "town", polygon: [[15,55],[40,55],[40,80],[15,80]], centroid: [27,67], monsterTypes: [], density: 1, farmingRating: 1, eliteCount: 0, description: "Myriam Jahzia's mystic shop. Enchant and transmogrify items here.", farmingTip: "Enchanting is how you fix bad secondary stats on otherwise good items. Focus on your weakest stat slot first.", connectedTo: ["town-square"] },
    { id: "graveyard", name: "Town Graveyard", type: "town", polygon: [[10,5],[40,5],[40,30],[10,30]], centroid: [25,17], monsterTypes: [], density: 1, farmingRating: 1, eliteCount: 0, description: "The graveyard in the northwest corner of New Tristram. Contains some lore objects.", farmingTip: "No farming value, but contains lore journals and ambient story details.", connectedTo: ["town-square"] },
    { id: "town-gate", name: "Town Gate", type: "transition", polygon: [[38,72],[62,72],[62,88],[38,88]], centroid: [50,80], monsterTypes: [], density: 1, farmingRating: 1, eliteCount: 0, description: "The main gate leading out of New Tristram to the Old Tristram Road and the wider world.", farmingTip: "This is your exit to all Act I zones. The waypoint just outside leads to Old Tristram Road.", connectedTo: ["town-square"] },
    { id: "cellar-entrance", name: "Inn Cellar Entrance", type: "dungeon", polygon: [[10,55],[25,55],[25,70],[10,70]], centroid: [17,62], monsterTypes: ["Undead"], density: 2, farmingRating: 2, eliteCount: 1, description: "The cellar beneath the Slaughtered Calf Inn. Contains undead and a guaranteed elite pack.", farmingTip: "Quick dungeon for early levels. Contains a Resplendent Chest on rare occasions.", connectedTo: ["inn-area"] },
  ],
  connections: [
    { from: "town-square", to: "blacksmith-area", type: "main-path", bidirectional: true, path: [[60,45],[60,37]] },
    { from: "town-square", to: "jeweler-area", type: "main-path", bidirectional: true, path: [[60,55],[60,62]] },
    { from: "town-square", to: "inn-area", type: "main-path", bidirectional: true, path: [[35,45],[35,42]] },
    { from: "town-square", to: "mystic-area", type: "main-path", bidirectional: true, path: [[40,65],[40,67]] },
    { from: "town-square", to: "graveyard", type: "main-path", bidirectional: true, path: [[40,35],[25,30]] },
    { from: "town-square", to: "town-gate", type: "main-path", bidirectional: true, path: [[50,65],[50,72]] },
    { from: "inn-area", to: "cellar-entrance", type: "dungeon", bidirectional: true, path: [[17,55],[17,55]] },
  ],
  pois: [
    { id: "t1-wp", x: 50, y: 50, type: "waypoint", name: "New Tristram", sublabel: "Town Waypoint", zoneId: "town-square", details: { description: "The main New Tristram waypoint. All artisans and followers available nearby.", tip: "Always the first waypoint to activate when starting a new game." } },
    { id: "t1-blacksmith", x: 72, y: 37, type: "npc", name: "Haedrig Eamon", sublabel: "Blacksmith", zoneId: "blacksmith-area", details: { description: "The town blacksmith. Craft weapons, armor, and salvage items for crafting materials.", tip: "Salvage all magic (blue) and rare (yellow) items you don't need. Materials are essential for crafting upgrades and Kanai's Cube recipes." } },
    { id: "t1-jeweler", x: 72, y: 62, type: "npc", name: "Covetous Shen", sublabel: "Jeweler", zoneId: "jeweler-area", details: { description: "The jeweler. Socket gems into items, combine lower-tier gems, and craft jewelry.", tip: "Combine gems whenever you have 3 of the same tier. Marquise is the minimum for endgame socketing." } },
    { id: "t1-mystic", x: 27, y: 67, type: "npc", name: "Myriam Jahzia", sublabel: "Mystic", zoneId: "mystic-area", details: { description: "The Mystic. Enchant items to reroll a secondary stat, and transmogrify items to change their appearance.", tip: "Enchanting is how you fix bad secondary stats. Focus on your most impactful slot — usually the stat that's furthest from ideal." } },
    { id: "t1-stash", x: 18, y: 38, type: "npc", name: "Stash", sublabel: "The Slaughtered Calf Inn", zoneId: "inn-area", details: { description: "Your personal item stash. Shared across all characters on your account.", tip: "Keep a dedicated tab for crafting materials, gems, and Kanai's Cube ingredients." } },
    { id: "t1-leah", x: 22, y: 42, type: "npc", name: "Leah", sublabel: "Inn — Story NPC", zoneId: "inn-area", details: { description: "Leah, Deckard Cain's niece. Central to the Act I story.", tip: "Talk to Leah to advance the main quest and unlock new areas." } },
    { id: "t1-gate", x: 50, y: 80, type: "exit", name: "Town Gate", sublabel: "Exit to Old Tristram Road", zoneId: "town-gate", details: { description: "The main gate leading out of New Tristram to the Old Tristram Road.", tip: "The waypoint just outside leads to all Act I zones. Always activate it on your first run." } },
    { id: "t1-cellar", x: 17, y: 62, type: "dungeon-entrance", name: "Inn Cellar", sublabel: "Beneath the Inn", zoneId: "cellar-entrance", details: { description: "A small dungeon beneath the inn. Contains undead and a guaranteed elite pack.", tip: "Quick early-level dungeon. Check for Resplendent Chest on rare occasions." } },
    { id: "t1-templar", x: 35, y: 50, type: "npc", name: "Kormac (Templar)", sublabel: "Follower", zoneId: "town-square", details: { description: "The Templar follower. Tank-oriented, provides healing and crowd control.", tip: "Best follower for solo players who need survivability. Equip him with a shield and healing items." } },
    { id: "t1-scoundrel", x: 40, y: 45, type: "npc", name: "Lyndon (Scoundrel)", sublabel: "Follower", zoneId: "town-square", details: { description: "The Scoundrel follower. Ranged damage dealer with crowd control abilities.", tip: "Best for speed farming. His Crippling Shot slows enemies. Equip with a crossbow and crit items." } },
  ],
  farmingRoutes: [],
};

export const act2TownData: ActGisData = {
  actId: "act2-town",
  actName: "Hidden Camp",
  subtitle: "Act II Hub — Desert Refuge outside Caldeum",
  accentColor: "#c8860a",
  parchmentImage: "https://d2xsxph8kpxj0f.cloudfront.net/310519663366635630/Yxk9jCSLASZ3Pr5PiwqTMZ/town-hidden-camp-QpjLQ4uoD74goHYu5DbXgR.webp",
  viewBox: "0 0 1000 700",
  zones: [
    { id: "camp-center", name: "Camp Center", type: "town", polygon: [[30,30],[70,30],[70,70],[30,70]], centroid: [50,50], monsterTypes: [], density: 1, farmingRating: 1, eliteCount: 0, description: "The central campfire area of the Hidden Camp. All paths lead through here.", farmingTip: "Navigation hub. All artisans are in the surrounding tents.", connectedTo: ["blacksmith-tent","jeweler-tent","mystic-tent","camp-exit-alcarnus","camp-exit-sewers"] },
    { id: "blacksmith-tent", name: "Blacksmith Tent", type: "town", polygon: [[5,15],[30,15],[30,45],[5,45]], centroid: [17,30], monsterTypes: [], density: 1, farmingRating: 1, eliteCount: 0, description: "Haedrig's forge tent in the Hidden Camp. Same services as New Tristram.", farmingTip: "Salvage items here before heading into the Dahlgur Oasis runs.", connectedTo: ["camp-center"] },
    { id: "jeweler-tent", name: "Jeweler Tent", type: "town", polygon: [[70,15],[95,15],[95,45],[70,45]], centroid: [82,30], monsterTypes: [], density: 1, farmingRating: 1, eliteCount: 0, description: "Covetous Shen's tent in the Hidden Camp.", farmingTip: "Combine gems between Oasis runs to keep your gem tier current.", connectedTo: ["camp-center"] },
    { id: "mystic-tent", name: "Mystic Tent", type: "town", polygon: [[70,55],[95,55],[95,85],[70,85]], centroid: [82,70], monsterTypes: [], density: 1, farmingRating: 1, eliteCount: 0, description: "Myriam's mystic tent in the Hidden Camp.", farmingTip: "Enchant your weakest stat slot after each major gear upgrade.", connectedTo: ["camp-center"] },
    { id: "camp-exit-alcarnus", name: "Road to Alcarnus", type: "transition", polygon: [[38,5],[62,5],[62,20],[38,20]], centroid: [50,12], monsterTypes: [], density: 1, farmingRating: 1, eliteCount: 0, description: "The path leading from the Hidden Camp to the Road to Alcarnus and the wider Act II zones.", farmingTip: "This is your exit to all Act II zones. The Khasim Outpost waypoint is just down this road.", connectedTo: ["camp-center"] },
    { id: "camp-exit-sewers", name: "Sewers Entrance", type: "transition", polygon: [[5,55],[20,55],[20,85],[5,85]], centroid: [12,70], monsterTypes: [], density: 1, farmingRating: 1, eliteCount: 0, description: "The entrance to the Sewers of Caldeum, accessible from the Hidden Camp.", farmingTip: "Quick access to the Caldeum sewers for bounties and early Act II runs.", connectedTo: ["camp-center"] },
  ],
  connections: [
    { from: "camp-center", to: "blacksmith-tent", type: "main-path", bidirectional: true, path: [[30,45],[17,45]] },
    { from: "camp-center", to: "jeweler-tent", type: "main-path", bidirectional: true, path: [[70,35],[70,30]] },
    { from: "camp-center", to: "mystic-tent", type: "main-path", bidirectional: true, path: [[70,65],[70,70]] },
    { from: "camp-center", to: "camp-exit-alcarnus", type: "main-path", bidirectional: true, path: [[50,30],[50,20]] },
    { from: "camp-center", to: "camp-exit-sewers", type: "optional", bidirectional: true, path: [[30,65],[12,70]] },
  ],
  pois: [
    { id: "t2-wp", x: 50, y: 50, type: "waypoint", name: "Hidden Camp", sublabel: "Town Waypoint", zoneId: "camp-center", details: { description: "The Hidden Camp waypoint.", tip: "Always activate first. This is your base for all Act II runs." } },
    { id: "t2-blacksmith", x: 17, y: 30, type: "npc", name: "Haedrig Eamon", sublabel: "Blacksmith", zoneId: "blacksmith-tent", details: { description: "The blacksmith. Same services as New Tristram.", tip: "Salvage all items you don't need before heading into the Oasis." } },
    { id: "t2-jeweler", x: 82, y: 30, type: "npc", name: "Covetous Shen", sublabel: "Jeweler", zoneId: "jeweler-tent", details: { description: "The jeweler. Combine gems between runs.", tip: "Flawless Royal gems are the endgame standard. Start combining early." } },
    { id: "t2-mystic", x: 82, y: 70, type: "npc", name: "Myriam Jahzia", sublabel: "Mystic", zoneId: "mystic-tent", details: { description: "The Mystic. Enchant and transmogrify items.", tip: "Enchant your worst secondary stat after each gear upgrade." } },
    { id: "t2-stash", x: 45, y: 55, type: "npc", name: "Stash", sublabel: "Hidden Camp", zoneId: "camp-center", details: { description: "Your personal stash in the Hidden Camp.", tip: "Keep a tab for Act II-specific crafting materials." } },
    { id: "t2-exit-main", x: 50, y: 12, type: "exit", name: "Road to Alcarnus", sublabel: "Exit to Act II Zones", zoneId: "camp-exit-alcarnus", details: { description: "The main exit from the Hidden Camp to all Act II zones.", tip: "The Khasim Outpost waypoint is just down this road." } },
    { id: "t2-exit-sewers", x: 12, y: 70, type: "dungeon-entrance", name: "Sewers Entrance", sublabel: "Sewers of Caldeum", zoneId: "camp-exit-sewers", details: { description: "Entrance to the Sewers of Caldeum.", tip: "Good for bounties. Dense demon population in the sewers." } },
    { id: "t2-enchantress", x: 55, y: 45, type: "npc", name: "Eirena (Enchantress)", sublabel: "Follower", zoneId: "camp-center", details: { description: "The Enchantress follower. Provides crowd control and damage buffs.", tip: "Best for group play. Her Powered Armor and Erosion abilities amplify team damage." } },
  ],
  farmingRoutes: [],
};

export const act3TownData: ActGisData = {
  actId: "act3-town",
  actName: "Bastion's Keep Stronghold",
  subtitle: "Act III Hub — Last Fortress of Humanity",
  accentColor: "#c0392b",
  parchmentImage: "https://d2xsxph8kpxj0f.cloudfront.net/310519663366635630/Yxk9jCSLASZ3Pr5PiwqTMZ/town-bastions-keep-487DEDAQuGYgkgxtuhHmfU.webp",
  viewBox: "0 0 1000 700",
  zones: [
    { id: "great-hall", name: "Great Hall", type: "town", polygon: [[30,35],[70,35],[70,65],[30,65]], centroid: [50,50], monsterTypes: [], density: 1, farmingRating: 1, eliteCount: 0, description: "The great hall of Bastion's Keep. The command center of the last human stronghold.", farmingTip: "Navigation hub. All artisans and the stash are accessible from here.", connectedTo: ["war-room","barracks","armory","blacksmith-forge","jeweler-workshop","mystic-chamber","gate-stonefort","stairs-keep-depths"] },
    { id: "war-room", name: "War Room", type: "town", polygon: [[5,10],[40,10],[40,35],[5,35]], centroid: [22,22], monsterTypes: [], density: 1, farmingRating: 1, eliteCount: 0, description: "The war room with the tactical map table. Story NPCs gather here.", farmingTip: "Talk to General Torion here to advance the Act III story.", connectedTo: ["great-hall"] },
    { id: "barracks", name: "Barracks", type: "town", polygon: [[60,10],[95,10],[95,35],[60,35]], centroid: [77,22], monsterTypes: [], density: 1, farmingRating: 1, eliteCount: 0, description: "The soldiers' barracks. Contains bunk beds and supplies.", farmingTip: "No gameplay value but contains ambient lore.", connectedTo: ["great-hall"] },
    { id: "armory", name: "Armory", type: "town", polygon: [[5,35],[25,35],[25,65],[5,65]], centroid: [15,50], monsterTypes: [], density: 1, farmingRating: 1, eliteCount: 0, description: "The fortress armory with weapon racks and armor stands.", farmingTip: "No gameplay value. Contains ambient lore objects.", connectedTo: ["great-hall"] },
    { id: "blacksmith-forge", name: "Blacksmith Forge", type: "town", polygon: [[5,65],[30,65],[30,90],[5,90]], centroid: [17,77], monsterTypes: [], density: 1, farmingRating: 1, eliteCount: 0, description: "Haedrig's forge in Bastion's Keep. Same services as previous acts.", farmingTip: "Salvage all items before heading into the Keep Depths or Rakkis Crossing.", connectedTo: ["great-hall"] },
    { id: "jeweler-workshop", name: "Jeweler Workshop", type: "town", polygon: [[70,65],[95,65],[95,90],[70,90]], centroid: [82,77], monsterTypes: [], density: 1, farmingRating: 1, eliteCount: 0, description: "Covetous Shen's workshop in Bastion's Keep.", farmingTip: "Combine gems between Keep Depths runs.", connectedTo: ["great-hall"] },
    { id: "mystic-chamber", name: "Mystic Chamber", type: "town", polygon: [[75,35],[95,35],[95,65],[75,65]], centroid: [85,50], monsterTypes: [], density: 1, farmingRating: 1, eliteCount: 0, description: "Myriam's mystic chamber in Bastion's Keep.", farmingTip: "Enchant your weakest stat after each gear upgrade.", connectedTo: ["great-hall"] },
    { id: "gate-stonefort", name: "Gate to Stonefort", type: "transition", polygon: [[38,5],[62,5],[62,15],[38,15]], centroid: [50,10], monsterTypes: [], density: 1, farmingRating: 1, eliteCount: 0, description: "The gate leading from Bastion's Keep to the Stonefort battlements.", farmingTip: "Exit to all Act III outdoor zones. The Stonefort waypoint is just outside.", connectedTo: ["great-hall"] },
    { id: "stairs-keep-depths", name: "Stairs to Keep Depths", type: "dungeon", polygon: [[38,85],[62,85],[62,98],[38,98]], centroid: [50,91], monsterTypes: ["Demon"], density: 5, farmingRating: 5, eliteCount: 4, description: "The stairs descending into the Keep Depths — one of the best farming zones in the game.", farmingTip: "Keep Depths has 4+ elite packs per level. Run both levels every game for maximum XP and loot.", connectedTo: ["great-hall"] },
  ],
  connections: [
    { from: "great-hall", to: "war-room", type: "main-path", bidirectional: true, path: [[30,42],[22,35]] },
    { from: "great-hall", to: "barracks", type: "main-path", bidirectional: true, path: [[70,42],[70,35]] },
    { from: "great-hall", to: "armory", type: "main-path", bidirectional: true, path: [[30,50],[25,50]] },
    { from: "great-hall", to: "blacksmith-forge", type: "main-path", bidirectional: true, path: [[30,65],[17,65]] },
    { from: "great-hall", to: "jeweler-workshop", type: "main-path", bidirectional: true, path: [[70,65],[70,65]] },
    { from: "great-hall", to: "mystic-chamber", type: "main-path", bidirectional: true, path: [[70,50],[75,50]] },
    { from: "great-hall", to: "gate-stonefort", type: "main-path", bidirectional: true, path: [[50,35],[50,15]] },
    { from: "great-hall", to: "stairs-keep-depths", type: "dungeon", bidirectional: true, path: [[50,65],[50,85]] },
  ],
  pois: [
    { id: "t3-wp", x: 50, y: 50, type: "waypoint", name: "Bastion's Keep Stronghold", sublabel: "Town Waypoint", zoneId: "great-hall", details: { description: "The main Bastion's Keep waypoint.", tip: "Always activate first. All artisans are nearby." } },
    { id: "t3-blacksmith", x: 17, y: 77, type: "npc", name: "Haedrig Eamon", sublabel: "Blacksmith", zoneId: "blacksmith-forge", details: { description: "The blacksmith in Bastion's Keep.", tip: "Salvage all items before heading into the Keep Depths." } },
    { id: "t3-jeweler", x: 82, y: 77, type: "npc", name: "Covetous Shen", sublabel: "Jeweler", zoneId: "jeweler-workshop", details: { description: "The jeweler in Bastion's Keep.", tip: "Combine gems between runs." } },
    { id: "t3-mystic", x: 85, y: 50, type: "npc", name: "Myriam Jahzia", sublabel: "Mystic", zoneId: "mystic-chamber", details: { description: "The Mystic in Bastion's Keep.", tip: "Enchant your weakest stat after each upgrade." } },
    { id: "t3-stash", x: 45, y: 55, type: "npc", name: "Stash", sublabel: "Great Hall", zoneId: "great-hall", details: { description: "Your stash in Bastion's Keep.", tip: "Keep a tab for Act III crafting materials." } },
    { id: "t3-gate", x: 50, y: 10, type: "exit", name: "Gate to Stonefort", sublabel: "Exit to Act III Zones", zoneId: "gate-stonefort", details: { description: "The main gate leading to all Act III outdoor zones.", tip: "Stonefort waypoint is just outside — activate it for fast Keywarden access." } },
    { id: "t3-keep-depths", x: 50, y: 91, type: "dungeon-entrance", name: "Keep Depths Entrance", sublabel: "Best Farming Zone in Act III", zoneId: "stairs-keep-depths", details: { description: "Stairs descending into the Keep Depths — 4+ elite packs per level.", tip: "Run both levels every game. One of the highest XP/hour zones in the entire game." } },
  ],
  farmingRoutes: [],
};

export const act4TownData: ActGisData = {
  actId: "act4-town",
  actName: "The Diamond Gates",
  subtitle: "Act IV Hub — Entry to the High Heavens",
  accentColor: "#5b9bd5",
  parchmentImage: "https://d2xsxph8kpxj0f.cloudfront.net/310519663366635630/Yxk9jCSLASZ3Pr5PiwqTMZ/town-diamond-gates-FztGRP7KDNJbWK9P9ujfSi.webp",
  viewBox: "0 0 1000 700",
  zones: [
    { id: "celestial-hall", name: "Celestial Entry Hall", type: "town", polygon: [[30,30],[70,30],[70,70],[30,70]], centroid: [50,50], monsterTypes: [], density: 1, farmingRating: 1, eliteCount: 0, description: "The grand entry hall of the High Heavens. A glowing portal dominates the center.", farmingTip: "Navigation hub. All artisans are in the side chambers.", connectedTo: ["blacksmith-chamber","jeweler-chamber","mystic-chamber-a4","exit-gardens","exit-spire"] },
    { id: "blacksmith-chamber", name: "Blacksmith Chamber", type: "town", polygon: [[5,25],[30,25],[30,55],[5,55]], centroid: [17,40], monsterTypes: [], density: 1, farmingRating: 1, eliteCount: 0, description: "Haedrig's divine forge chamber in the High Heavens.", farmingTip: "Salvage items before heading into the Gardens of Hope or Silver Spire.", connectedTo: ["celestial-hall"] },
    { id: "jeweler-chamber", name: "Jeweler Chamber", type: "town", polygon: [[70,25],[95,25],[95,55],[70,55]], centroid: [82,40], monsterTypes: [], density: 1, farmingRating: 1, eliteCount: 0, description: "Covetous Shen's celestial gem workshop.", farmingTip: "Combine gems between Silver Spire runs.", connectedTo: ["celestial-hall"] },
    { id: "mystic-chamber-a4", name: "Mystic Chamber", type: "town", polygon: [[30,70],[70,70],[70,90],[30,90]], centroid: [50,80], monsterTypes: [], density: 1, farmingRating: 1, eliteCount: 0, description: "Myriam's mystic chamber in the High Heavens.", farmingTip: "Enchant your weakest stat after each gear upgrade.", connectedTo: ["celestial-hall"] },
    { id: "exit-gardens", name: "Path to Gardens of Hope", type: "transition", polygon: [[5,55],[25,55],[25,85],[5,85]], centroid: [15,70], monsterTypes: [], density: 1, farmingRating: 1, eliteCount: 0, description: "The path leading to the Gardens of Hope.", farmingTip: "Gardens of Hope has 3+ elite packs. Good for bounties.", connectedTo: ["celestial-hall"] },
    { id: "exit-spire", name: "Path to Silver Spire", type: "transition", polygon: [[75,55],[95,55],[95,85],[75,85]], centroid: [85,70], monsterTypes: [], density: 1, farmingRating: 1, eliteCount: 0, description: "The path leading to the Silver Spire — the best Act IV farming zone.", farmingTip: "Silver Spire Level 2 has 4+ elite packs. Always run both levels.", connectedTo: ["celestial-hall"] },
    { id: "crystal-archway", name: "Crystal Archway Entrance", type: "transition", polygon: [[38,5],[62,5],[62,20],[38,20]], centroid: [50,12], monsterTypes: [], density: 1, farmingRating: 1, eliteCount: 0, description: "The grand crystal archway entrance to the Diamond Gates from the mortal realm.", farmingTip: "Entry point from Act III. Activate the Diamond Gates waypoint immediately.", connectedTo: ["celestial-hall"] },
  ],
  connections: [
    { from: "celestial-hall", to: "blacksmith-chamber", type: "main-path", bidirectional: true, path: [[30,45],[17,40]] },
    { from: "celestial-hall", to: "jeweler-chamber", type: "main-path", bidirectional: true, path: [[70,40],[70,40]] },
    { from: "celestial-hall", to: "mystic-chamber-a4", type: "main-path", bidirectional: true, path: [[50,70],[50,70]] },
    { from: "celestial-hall", to: "exit-gardens", type: "main-path", bidirectional: true, path: [[30,60],[15,60]] },
    { from: "celestial-hall", to: "exit-spire", type: "main-path", bidirectional: true, path: [[70,60],[85,60]] },
    { from: "celestial-hall", to: "crystal-archway", type: "main-path", bidirectional: true, path: [[50,30],[50,20]] },
  ],
  pois: [
    { id: "t4-wp", x: 50, y: 50, type: "waypoint", name: "The Diamond Gates", sublabel: "Town Waypoint", zoneId: "celestial-hall", details: { description: "The Diamond Gates waypoint.", tip: "Always activate first. All artisans are in the side chambers." } },
    { id: "t4-blacksmith", x: 17, y: 40, type: "npc", name: "Haedrig Eamon", sublabel: "Blacksmith", zoneId: "blacksmith-chamber", details: { description: "The blacksmith in the High Heavens.", tip: "Salvage items before heading into the Silver Spire." } },
    { id: "t4-jeweler", x: 82, y: 40, type: "npc", name: "Covetous Shen", sublabel: "Jeweler", zoneId: "jeweler-chamber", details: { description: "The jeweler in the High Heavens.", tip: "Combine gems between Silver Spire runs." } },
    { id: "t4-mystic", x: 50, y: 80, type: "npc", name: "Myriam Jahzia", sublabel: "Mystic", zoneId: "mystic-chamber-a4", details: { description: "The Mystic in the High Heavens.", tip: "Enchant your weakest stat after each upgrade." } },
    { id: "t4-stash", x: 50, y: 42, type: "npc", name: "Stash", sublabel: "Celestial Entry Hall", zoneId: "celestial-hall", details: { description: "Your stash in the Diamond Gates.", tip: "Keep a tab for Act IV crafting materials." } },
    { id: "t4-gardens", x: 15, y: 70, type: "exit", name: "Gardens of Hope", sublabel: "Act IV Zone", zoneId: "exit-gardens", details: { description: "Path to the Gardens of Hope.", tip: "3+ elite packs. Good for bounties and Keywarden farming." } },
    { id: "t4-spire", x: 85, y: 70, type: "exit", name: "Silver Spire", sublabel: "Best Act IV Farming Zone", zoneId: "exit-spire", details: { description: "Path to the Silver Spire — 4+ elite packs on Level 2.", tip: "Always run both levels. Silver Spire Level 2 leads directly to Diablo." } },
  ],
  farmingRoutes: [],
};

export const act5TownData: ActGisData = {
  actId: "act5-town",
  actName: "Survivors' Enclave",
  subtitle: "Act V Hub — Makeshift Camp in Westmarch",
  accentColor: "#8e44ad",
  parchmentImage: "https://d2xsxph8kpxj0f.cloudfront.net/310519663366635630/Yxk9jCSLASZ3Pr5PiwqTMZ/town-survivors-enclave-nnZPCq8vrdvBi7mfp2AbJo.webp",
  viewBox: "0 0 1000 700",
  zones: [
    { id: "enclave-center", name: "Enclave Center", type: "town", polygon: [[25,30],[75,30],[75,70],[25,70]], centroid: [50,50], monsterTypes: [], density: 1, farmingRating: 1, eliteCount: 0, description: "The central bonfire area of the Survivors' Enclave. Makeshift shelters surround the fire.", farmingTip: "Navigation hub. All artisans are in the surrounding shelters.", connectedTo: ["blacksmith-shelter","jeweler-shelter","mystic-shelter","gate-westmarch","dock-greyhollow"] },
    { id: "blacksmith-shelter", name: "Blacksmith Shelter", type: "town", polygon: [[5,15],[25,15],[25,50],[5,50]], centroid: [15,32], monsterTypes: [], density: 1, farmingRating: 1, eliteCount: 0, description: "Haedrig's improvised forge in the Survivors' Enclave.", farmingTip: "Salvage items before heading into the Ruins of Corvus or Battlefields.", connectedTo: ["enclave-center"] },
    { id: "jeweler-shelter", name: "Jeweler Shelter", type: "town", polygon: [[75,15],[95,15],[95,50],[75,50]], centroid: [85,32], monsterTypes: [], density: 1, farmingRating: 1, eliteCount: 0, description: "Covetous Shen's gem shelter in the Survivors' Enclave.", farmingTip: "Combine gems between Ruins of Corvus runs.", connectedTo: ["enclave-center"] },
    { id: "mystic-shelter", name: "Mystic Shelter", type: "town", polygon: [[75,50],[95,50],[95,85],[75,85]], centroid: [85,67], monsterTypes: [], density: 1, farmingRating: 1, eliteCount: 0, description: "Myriam's mystic shelter in the Survivors' Enclave.", farmingTip: "Enchant your weakest stat after each gear upgrade.", connectedTo: ["enclave-center"] },
    { id: "gate-westmarch", name: "Gate to Westmarch", type: "transition", polygon: [[38,5],[62,5],[62,18],[38,18]], centroid: [50,11], monsterTypes: [], density: 1, farmingRating: 1, eliteCount: 0, description: "The gate leading from the Survivors' Enclave into Westmarch Commons.", farmingTip: "Exit to all Act V zones. Westmarch Commons waypoint is just outside.", connectedTo: ["enclave-center"] },
    { id: "dock-greyhollow", name: "Dock to Greyhollow", type: "transition", polygon: [[75,70],[95,70],[95,90],[75,90]], centroid: [85,80], monsterTypes: [], density: 1, farmingRating: 1, eliteCount: 0, description: "A small dock leading to the mysterious Greyhollow Island.", farmingTip: "Greyhollow Island has unique spectral enemies and good bounties.", connectedTo: ["enclave-center"] },
    { id: "barricade-area", name: "Barricade Perimeter", type: "town", polygon: [[5,50],[25,50],[25,85],[5,85]], centroid: [15,67], monsterTypes: [], density: 1, farmingRating: 1, eliteCount: 0, description: "The makeshift barricades protecting the enclave from Westmarch's dangers.", farmingTip: "No gameplay value. Contains ambient lore objects.", connectedTo: ["enclave-center"] },
  ],
  connections: [
    { from: "enclave-center", to: "blacksmith-shelter", type: "main-path", bidirectional: true, path: [[25,42],[15,42]] },
    { from: "enclave-center", to: "jeweler-shelter", type: "main-path", bidirectional: true, path: [[75,32],[75,32]] },
    { from: "enclave-center", to: "mystic-shelter", type: "main-path", bidirectional: true, path: [[75,60],[75,67]] },
    { from: "enclave-center", to: "gate-westmarch", type: "main-path", bidirectional: true, path: [[50,30],[50,18]] },
    { from: "enclave-center", to: "dock-greyhollow", type: "optional", bidirectional: true, path: [[75,65],[85,70]] },
    { from: "enclave-center", to: "barricade-area", type: "main-path", bidirectional: true, path: [[25,60],[15,60]] },
  ],
  pois: [
    { id: "t5-wp", x: 50, y: 50, type: "waypoint", name: "Survivors' Enclave", sublabel: "Town Waypoint", zoneId: "enclave-center", details: { description: "The Survivors' Enclave waypoint.", tip: "Always activate first. All artisans are in the surrounding shelters." } },
    { id: "t5-blacksmith", x: 15, y: 32, type: "npc", name: "Haedrig Eamon", sublabel: "Blacksmith", zoneId: "blacksmith-shelter", details: { description: "The blacksmith in the Survivors' Enclave.", tip: "Salvage items before heading into the Ruins of Corvus or Battlefields of Eternity." } },
    { id: "t5-jeweler", x: 85, y: 32, type: "npc", name: "Covetous Shen", sublabel: "Jeweler", zoneId: "jeweler-shelter", details: { description: "The jeweler in the Survivors' Enclave.", tip: "Combine gems between Ruins of Corvus runs." } },
    { id: "t5-mystic", x: 85, y: 67, type: "npc", name: "Myriam Jahzia", sublabel: "Mystic", zoneId: "mystic-shelter", details: { description: "The Mystic in the Survivors' Enclave.", tip: "Enchant your weakest stat after each upgrade." } },
    { id: "t5-stash", x: 45, y: 55, type: "npc", name: "Stash", sublabel: "Enclave Center", zoneId: "enclave-center", details: { description: "Your stash in the Survivors' Enclave.", tip: "Keep a tab for Act V crafting materials." } },
    { id: "t5-gate", x: 50, y: 11, type: "exit", name: "Gate to Westmarch", sublabel: "Exit to Act V Zones", zoneId: "gate-westmarch", details: { description: "The main gate leading to all Act V zones.", tip: "Westmarch Commons waypoint is just outside. Ruins of Corvus is the best farming zone." } },
    { id: "t5-dock", x: 85, y: 80, type: "exit", name: "Greyhollow Island Dock", sublabel: "Optional Zone", zoneId: "dock-greyhollow", details: { description: "Dock leading to Greyhollow Island.", tip: "Unique spectral enemies and good bounties. Worth visiting for bounty caches." } },
  ],
  farmingRoutes: [],
};

// ─── All town hub data ────────────────────────────────────────────────────────
export const ALL_TOWN_GIS_DATA: Record<string, ActGisData> = {
  "act1-town": act1TownData,
  "act2-town": act2TownData,
  "act3-town": act3TownData,
  "act4-town": act4TownData,
  "act5-town": act5TownData,
};
